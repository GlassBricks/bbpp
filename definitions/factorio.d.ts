...
interface LuaGameScript {
  ...
  readonly autoplace_control_prototypes: Record<string,
  ...
  readonly resource_category_prototypes: Record<string,
    LuaResourceCategoryPrototype>
  readonly achievement_prototypes: Record<string, LuaAchievementPrototype>
  readonly module_category_prototypes: Record<string,
    LuaModuleCategoryPrototype>
  readonly equipment_category_prototypes: Record<string,
  ...
  readonly recipe_category_prototypes: Record<string,
